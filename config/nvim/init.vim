...
" Formatting {
    ...
    set cinoptions=l1,(0,W1s        " set C indent options
...
function! SetupRustProject()
    ...
    if TMUX()
        nnoremap <silent> <leader>br :VimuxRunCommand("cd " . projectroot#guess() . g:coeuvre_shell_cmd_and . "clear" . g:coeuvre_shell_cmd_and . "cargo run")<cr>
        nnoremap <silent> <leader>bt :VimuxRunCommand("cd " . projectroot#guess() . g:coeuvre_shell_cmd_and . "clear" . g:coeuvre_shell_cmd_and . "cargo test -- --nocapture")<cr>
    elseif GUI()
